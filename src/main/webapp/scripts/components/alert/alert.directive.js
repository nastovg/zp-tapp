        ...
        return {
            ...
            controller: ['$scope',
                function ($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('tappApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-tappApp-error');
                                var entityKey = httpResponse.headers('X-tappApp-params');
                                if (errorHeader) {
